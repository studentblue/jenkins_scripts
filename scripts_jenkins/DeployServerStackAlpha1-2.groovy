		...
		node ->
			...
			[
				...
				[
					...
					"simpleNetworkList": [ "type": "array", "items": ["type": "string"], "default": generateSimpleNetworkList(node) , "options":
					["hidden": true]],
					"simpleContainerList": [ "type": "array", "items": ["type": "string"], "default": generateSimpleContainerList(node) , "options":
					["hidden": true]]
				],
				//~ "required": ["name"],
				"additionalProperties": false
